...
| `tests/` | 66 tests: invariants (incl. bit-identical lookahead test), 11 named failure-mode regressions, synthetic suite |
| `tools/mutation_test.py` | 19 safety mutations, each must be detected by a failing test |
