...
|---|---|---|---|---|---|---|---|
| dual momentum 12-1 ⚠12 data refusals | 7.95% | 15.20% | 0.58 | -27.43% | 2,556 | 0.57% | 105,795 |
| buy-and-hold DCA 100% US equity | 13.59% | 15.93% | 0.88 | -27.83% | 94 | 0.02% | 152,969 |
| buy-and-hold DCA 60/40 | 8.63% | 10.24% | 0.86 | -20.02% | 123 | 0.03% | 108,237 |

## 2. Net return by account size (no contributions)

| config | CAGR (TWR) | vol | Sharpe | maxDD | fees paid | fee drag/yr | final $ |
|---|---|---|---|---|---|---|---|
| $1,000 ⚠12 data refusals | 7.70% | 15.30% | 0.56 | -28.41% | 146 | 0.90% | 2,342 |
| $2,500 ⚠12 data refusals | 7.98% | 15.45% | 0.57 | -28.39% | 286 | 0.69% | 6,030 |
| $5,000 ⚠12 data refusals | 7.99% | 15.47% | 0.57 | -28.39% | 572 | 0.69% | 12,078 |
| $10,000 ⚠12 data refusals | 7.99% | 15.48% | 0.57 | -28.44% | 1,146 | 0.69% | 24,165 |
| $25,000 ⚠12 data refusals | 8.00% | 15.49% | 0.57 | -28.45% | 2,867 | 0.69% | 60,463 |
| $100,000 ⚠12 data refusals | 8.00% | 15.50% | 0.57 | -28.46% | 11,473 | 0.69% | 241,910 |

## 3. Cost sensitivity ($5,000 start, no contributions)

| config | CAGR (TWR) | vol | Sharpe | maxDD | fees paid | fee drag/yr | final $ |
|---|---|---|---|---|---|---|---|
| commission x0.0 ⚠12 data refusals | 8.27% | 15.46% | 0.59 | -28.19% | 371 | 0.44% | 12,444 |
| commission x0.5 ⚠12 data refusals | 8.14% | 15.45% | 0.58 | -28.15% | 473 | 0.57% | 12,266 |
| commission x1.0 ⚠12 data refusals | 7.99% | 15.47% | 0.57 | -28.39% | 572 | 0.69% | 12,078 |
| commission x2.0 ⚠12 data refusals | 7.69% | 15.47% | 0.56 | -28.85% | 766 | 0.95% | 11,692 |
| commission x4.0 ⚠12 data refusals | 7.12% | 15.50% | 0.52 | -29.68% | 1,135 | 1.46% | 11,002 |
| spread 5bps ⚠12 data refusals | 8.16% | 15.45% | 0.59 | -28.15% | 447 | 0.53% | 12,298 |
| spread 20bps ⚠12 data refusals | 7.65% | 15.48% | 0.55 | -28.85% | 816 | 1.01% | 11,652 |
| spread 40bps ⚠12 data refusals | 6.95% | 15.48% | 0.51 | -29.66% | 1,274 | 1.65% | 10,803 |
...
| config | CAGR (TWR) | vol | Sharpe | maxDD | fees paid | fee drag/yr | final $ |
|---|---|---|---|---|---|---|---|
| dual momentum 12-1 (US) ⚠HALTED ⚠12 data refusals | 2.51% | 11.05% | 0.28 | -35.02% | 105 | 0.05% | 8,823 |
